...
public class App {
  ...
  public static void usage() {
    ...
    System.out.println(
        "run_synthea -m moduleFilename" + File.pathSeparator + "anotherModule" + File.pathSeparator + "module*");
        ...
        while (!argsQ.isEmpty()) {
          ...
          if (currArg.equalsIgnoreCase("-h")) {
            ...
            if (localModuleDir.exists() && localModuleDir.isDirectory()) {
              ...
              throw new FileNotFoundException(String.format("Specified local module directory (%s) is not a directory",
            ...
            try {
              ...
              throw new IOException(
                  String.format("Unable to create snapshot file (%s): %s", file.getAbsolutePath(), ex.getMessage()));
            }
            ...
            try {
              ...
              throw new IOException(
                  String.format("Unable to load snapshot file (%s): %s", file.getAbsolutePath(), ex.getMessage()));
            }
            ...
            try {
              ...
              throw new IllegalArgumentException(
                  String.format("Error in specified updateTimePeriodInDays (%s): %s", value, ex.getMessage()));
            }
  ...
  private static void failIfPhysiologyEnabled(String arg) {
    if (Boolean.valueOf(Config.get("physiology.generators.enabled", "false"))) {
      String errString = String.format("The %s command line switch %s - %s", arg,
